...
-- в кавычках вставить содержимое схемы из файла
	...
	<xsd:element name="CustReg">
		<xsd:complexType>
			<xsd:sequence maxOccurs="unbounded">
				<!--fixme схема не пропускает больше одного тэга "step"-->
...
PRINT 'Создана коллекция схем XSD - dbo.SchemaCollectionXsd'
GO
