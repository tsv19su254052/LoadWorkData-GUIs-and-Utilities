...
for AC, AL, FN, Dep, Arr in zip(ListAirCraft, ListAirLineCodeIATA, ListFlightNumber, ListAirPortDeparture, ListAirPortArrival):
    ...
    # fixme в этом месте загрузки велись неправильно (читались коды IATA, сравнивали по коду ICAO) - версии 4 и 5 с ошибками загрузки, исправил 6-ой версии базы данных, рабочие данные загрузить снова
