...
#  посмотреть, чтобы в репозитории на github-е появился значек, что она применяется. В импортируемом репозитории на github-е папка с подмодулем должна быть написана синим текстом
