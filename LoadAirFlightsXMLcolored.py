...
#       - Посмотреть, чтобы в репозитории на github-е появился значек "Used by ...", что она применяется -> Пока не наблюдается
...
#  можно полностью перенести на github в виде релизов (по одной ветке на каждый релиз). Версия тут - чистая формальность
