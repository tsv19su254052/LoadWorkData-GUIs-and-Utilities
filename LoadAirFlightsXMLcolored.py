...
# todo Было бы удобно, если бы внутри pyCharm-а был функционал (не просто плагин для подсветки синтаксиса) для работы с XML-ными файлами, как в MicroSoft XML Notepad
