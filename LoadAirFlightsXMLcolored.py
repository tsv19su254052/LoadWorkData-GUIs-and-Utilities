...
# todo Было бы удобно, если бы внутри pyCharm-а для работы с XML-ными файлами был не просто плагин для подсветки синтаксиса, а функционал, как в MicroSoft XML Notepad
