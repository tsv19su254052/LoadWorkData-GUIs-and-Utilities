...
# todo Сделать пользовательскую библиотеку отдельным репозиторием (как альтернативу виртуальному окружению) и импортировать ее внутри репозитория для повторного применения
#  синхронно или асинхронно. Посмотреть, чтобы в репозитории на github-е появился значек, что она применяется. В импортируемом репозитории на github-е папка с подмодулем должна
#  быть написана синим текстом. Будет ли импорт в чистом виде или будет дублировнание места на github-е и на pyCharm-е?
