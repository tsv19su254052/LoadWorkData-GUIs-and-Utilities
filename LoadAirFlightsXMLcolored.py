...
# todo Научиться делать это по возможности только внутри pyCharm-а -> pyCharm как графическая оболочка пока не поддерживают 'git submodules' [@Aleks10](https://qna.habr.com/q/196071) и связанные с ним команды
