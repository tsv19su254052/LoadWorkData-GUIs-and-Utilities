...
# todo  - Сделать пользовательскую наработку (не библиотеку) отдельным репозиторием (как альтернативу виртуальному окружению) -> Использовал существующую, как пример
