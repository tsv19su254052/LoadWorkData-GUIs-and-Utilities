...
class Server:
    ...
    def QueryAirLineByIATA(self, iata):
        ...
        try:
            ...
            # READ COMMITTED (Чтение зафиксированных данных - в настройках по умолчанию) инструкции не могут считывать данные, которые были изменены и еще не зафиксированы другими транзакциями Другие транзакции могут изменять и вставлять данные, читаемые текущей транзакцией
            # REPEATABLE READ (Повторяемость чтения) - Дополнительно: Другие транзакции могут только вставлять данные, читаемые текущей транзакцией
            # SERIALIZABLE (Упорядочиваемость) - Дополнительно: Другие транзакции не могут изменять и вставлять данные в диапазон, читаемые текущей транзакцией
            #
