...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.button_start_logging = QPushButton("Start", toolTip="Start data logging")
        self.button_start_logging.clicked.connect(Cmd.sensor_start)

        # SENSOR: Start Data Logging
        self.button_end_logging = QPushButton("End", toolTip="End data logging")
        self.button_end_logging.clicked.connect(Cmd.sensor_end)

        # MISSION: Start Mission
        self.button_start_uav = QPushButton("Start", toolTip="Start UAV mission")
        self.button_start_uav.clicked.connect(Cmd.mission_start)

        # MISSION: End Mission
        self.button_end_uav = QPushButton("End", toolTip="End UAV mission")
        self.button_end_uav.clicked.connect(Cmd.mission_end)

        # MISSION: Hold Mission
        self.button_hold_uav = QPushButton("Hold", toolTip="Hold UAV mission")
        self.button_hold_uav.clicked.connect(Cmd.mission_hold)
