...
Структура хранилища с базами данных - **Снежинка**. В центре - таблицы с рабочими и оперативными данными, по краям - таблицы со справочными данными, которые ссылаются на таблицы с другими справочными данными. Таблицы с тестовыми рабочими и оперативными данными вынесены на другой жесткий диск и ссылаются на те же таблицы со справочными данными, что и рабочие таблицы. Таблицы могут быть в разных базах данных. Таблицы со справочными данными вынесены в отдельные базы данных. Каскадные правила на обновления и удаление данных в них не требуется. Отношение первичный ключ - внешний ключ заменены на ссылки. Целостность данных обеспечена.
