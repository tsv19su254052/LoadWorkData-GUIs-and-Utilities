...
Структура хранилища с базами данных - **Снежинка** (в центре - таблицы с рабочими и оперативными данными, по краям - таблицы со справочными данными, которые ссылаются на другие со справочными данными). Тестовые таблицы с рабочими и оперативными данными вынесены в отдельные тестовые базы на другом жестком диске и ссылаются на те же таблицы со справочными данными, что и рабочие таблицы.
