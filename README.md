...
Уточнить применение комплектного с **MS SQL** функционала **XPath & XQuery** и комплектной спецификации **SQL/XML**, чтобы парсить поля **XML(CONTENT dbo.XSD-схема)** как **DOM** в таблицах баз данных и применить в базе данных летательных аппаратов таким образом, чтобы:
