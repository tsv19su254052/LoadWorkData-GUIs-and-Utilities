...
В базах данных:
 - версиях 3 ... 5 у летательных аппаратов регистрация и авиакомпании не указываются, авиарейсы плюсуются,
...
Все XML-ные поля подаются на вход хранимой процедуры через одну XSD-схему (имя корневого тэга соответствует имени элемента XSD-схемы) за один раз.
...
В одной XSD-схеме несколько элементов со своими именами. Схем может быть несколько.
