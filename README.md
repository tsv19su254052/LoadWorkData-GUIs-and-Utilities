...
(см. https://www.w3.org/TR/xmlschema11-1/) и типы данных XPath & XQuery, применяемые в XML-ных полях.
В XSD-схеме могут быть объявлены несколько элементов, каждый под своим именем (см. https://www.w3schools.com/xml/schema_simple.asp).
