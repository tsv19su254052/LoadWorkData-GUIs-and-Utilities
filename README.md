...
Примечания:
 ...
 - В версии 7 базы данных летательных аппаратов хронология регистраций и авиакомпаний сделана по принципу _медленно меняющейся размерности_ в отдельной таблице справочных данных. 
