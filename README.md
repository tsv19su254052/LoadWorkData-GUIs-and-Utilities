...
В объем данного проекта входит:
 ...
 - предоставление способа взаимодействия с базами данных из других проектов с помощью API-шек.
...
Исходный текст XSD-схемы вставляется в SQL-ный скрипт ее привязки к базе данных (надо найти способ добавить удобства и не вставлять исходник схемы через буфер обмена, а выбирать ее в диалоге открытия файла, чтобы дать на вход скрипту привязки).
