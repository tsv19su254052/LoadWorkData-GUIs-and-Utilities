...
Версия 7 (разработка пока на паузе, наработки переносятся в версию 8):
 - у летательных аппаратов по принципу [_медленно меняющейся размерности_](https://en.wikipedia.org/wiki/Slowly_changing_dimension) сделана хронология регистраций
