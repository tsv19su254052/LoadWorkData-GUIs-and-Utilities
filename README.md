...
Предусматривается работа клиентов внутри инфраструктуры с сервером СУБД по учеткам Windows Server-ов без контроллера домена и с заранее сделанной конфигой сервера СУБД: 
