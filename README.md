...
В соответствии с этим ищем строку летательного аппарата с данной регистрацией в данный период времени (парсим каждое XML-ное поле регистрации по аттрибуту-строке)
