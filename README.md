...
В объем данного проекта входит:
 ...
 - правка справочных данных с помощью графических оболочек,
...
(получилось, не получилось с указанием причины
см. https://docs.microsoft.com/ru-ru/sql/relational-databases/stored-procedures/return-data-from-a-stored-procedure?view=sql-server-ver15).
