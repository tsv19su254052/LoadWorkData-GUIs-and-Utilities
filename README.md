...
Доработать базу данных по летательным аппаратам таким образом, чтобы:
 ...
 - парсить их по веткам и подветкам, дописывать новую ветку и подветку или дописывать в существующую ветку новую подветку по указанному аттрибуту с указанной датой в соответствии с хронологией с помощью хранимой процедуры,
 - вынести в хранимую процедуру часть на XPath & XQuery для облегчения отладки. 
