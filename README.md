...
История изменений и улучшений в базах данных:
 ...
 - версия 8 - хронология регистраций и авиакомпаний пишется в XML-ных полях, функционал 7-й версии используется для временного хранения рабочих и оперативных данных, если регистрации пока нет в базе данных.
...
В процессе загрузки рабочих и оперативных данных составляем список регистраций, которые надо восполнить. Недозагруженные данные на время пишутся во временную таблицу 7-й версии.
