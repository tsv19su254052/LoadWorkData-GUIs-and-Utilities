...
Рабочие по авиаперелетам загружались с таблиц https://www.transtats.bts.gov/DL_SelectFields.asp?gnoyr_VQ=FGJ&QO_fu146_anzr=b0-gvzr
...
Недостаток XSD-схемы - тот же.
 ...
 - Сделать графическую формочку для правки свойств альянсов (или делать это внутри Management Studio). Добавить ссылку на Wikipedia
 ...
 - Дополнить данные по маршрутам их профилями (возможно с привязкой к картам Google) и топологиями, их изменениями с течением времени
 - Разработать загрузку оперативных данных с помощью API-шек по ВЭБ-хукам
