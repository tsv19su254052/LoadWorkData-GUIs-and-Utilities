...
Пространства имен для всех элементов объявляются в начале скрипта создания XSD-схемы
(см. https://www.w3schools.com/xml/schema_simple.asp и https://www.w3.org/TR/xmlschema11-1/).
Типы данных XPath & XQuery, применяемые в XML-ных полях, соответствуют объявленным пространствам имен
