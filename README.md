...
XML-ное поле регистрации летательного аппарата:
 - В каждом XML-ном поле регистрации летательного аппарата может быть только по одной ветке с **аттрибутом-строкой** (далее по тексту аттрибутом), обозначающим какую-то одну регистрацию.
 ...
 - Убираем предыдущую подветку, если она переходит не в начало временного диапазона с данной регистрацией.
...
По одному XML-ному полю на авиакомпанию-лизингодателя, авиакомпанию-арендодателя, авиакомпанию-арендатора (владельца) и авиакомпанию-оператора при их наличии:
 ...
 - В соответствии с этим пишем новую ветку и подветку или дописываем в существующую ветку новую подветку в соответствии с хронологией.
 - Убираем предыдущую подветку, если она переходит не в начало временного диапазона в данной авиакомпании.
