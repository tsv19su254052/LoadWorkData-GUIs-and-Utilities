...
XML-ное поле регистрации летательного аппарата:
 - В XML-ном поле регистрации летательного аппарата может быть только по одной ветке с **аттрибутом-строкой** (далее по тексту аттрибутом), обозначающим какую-то одну регистрацию.
...
По одному XML-ному полю на авиакомпанию-лизингодателя, авиакомпанию-арендодателя, авиакомпанию-арендатора (владельца) и авиакомпанию-оператора:
 ...
 - В XML-ном поле авиакомпании на одну авиакомпанию может быть только по одной ветке с **аттрибутом-идентификатором** (далее по тексту аттрибутом), указывающим на какую-то одну соответствующую запись в базе данных авиакомпаний.
...
###### Делаем **XML**-ные поля (надо сделать поля, как написано выше)
