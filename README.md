...
История изменений и улучшений в базах данных:
 ...
 - версия 8 - хронология регистраций и авиакомпаний пишется в XML-ных полях (для временного хранения рабочих и оперативных данных, у которых в базе данных еще нет регистрации, используется функционал 7-й версии).
