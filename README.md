...
История изменений и улучшений в базах данных:
 ...
 - версия 8 - хронология регистраций и авиакомпаний дополнена в XML-ных полях.
...
В процессе загрузки рабочих и оперативных данных составляем список регистраций, которые надо восполнить, чтобы дозагрузить незагруженные данные, которые на время пишутся во временную таблицу 7-й версии.
