...
Примечания:
 ...
 - В версии 3 ... 5 баз данных летательных аппаратов регистрация и авиакомпания не указаны.
 - В версии 6 базы данных летательных аппаратов записаны крайняя регистрация и крайняя авиакомпания.
 - В версии 7 базы данных летательных аппаратов хронология регистраций и авиакомпаний сделана по принципу _медленно меняющейся размерности_ через отдельную таблицу справочных данных (бизнес-ключ - сочетание заводских номеров, суррогатный ключ -  регистрации и авиакомпании по периодам использования). 
