...
#### Общая идея по хранению информации в файлах различных типов
...
![SSMS - XML-код - Создать схему](https://user-images.githubusercontent.com/104857185/167261451-a42a0c66-2888-4042-88a2-679f1ef6549a.png)
 ...
 - Если делать noSQL-ные базы данных по авиакомпаниям и по летательным аппаратам, то работать с данными в них видимо придется через графические формочки с изменяемыми наборами виджетов
