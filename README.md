...
В объем данного проекта входит:
 ...
 - предоставление способа работы с базами данных из других проектов.
...
Таблица летательных аппаратов содержит справочные поля, ввод в которые делается только вручную из авторитетных источников,
...
Версии 4, 5 (теперь не актуальны):
