...
Считаем, что начало периода использования в следующей авиакомпании совпадает с окончанием периода использования в предыдущей, так как в рабочих данных не указаны периоды бездействия. Поэтому окончание не пишем, чтобы избежать дублирования данных.
