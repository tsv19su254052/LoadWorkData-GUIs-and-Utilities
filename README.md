...
Для облегчения отладки выносим вставку или обновление XML-ных полей в хранимую процедуру вместе с частью на XPath & XQuery. Все XML-ные поля даем на вход хранимой процедуре через одну XSD-схему (каждое XML-ное поле через свой элемент XSD-схемы в соответствии с его именем за один раз).
