...
(позднее сделаем это XML-ное поле XML-ным индексом) и в каждом XML-ном поле авиакомпании этой строки относительно корневого тэга:
 - вставляем новый тэг и новый подтэг или в существующий тэг с указанным аттрибутом-идентификатором авиакомпании вставляем новый подтэг,
...
В процессе загрузки рабочих и оперативных данных составляем список регистраций, которые надо восполнить, чтобы затем дозагрузить незагруженные данные.
