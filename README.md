...
парсим в ней XML-ное поле регистрации по тэгу с указанным аттрибутом-строкой с данной регистрацией в данном временном диапазоне
(позднее сделаем это XML-ное поле XML-ным индексом) и в каждом XML-ном поле авиакомпании этой строки относительно корневого тэга:
...
В процессе загрузки рабочих и оперативных данных составляем список регистраций и дат авиарейсов, которые не найдены и которые надо восполнить,
чтобы затем дозагрузить незагруженные данные.
