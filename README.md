...
Аттрибуты-идентификаторы в разных XML-ных полях могут указывать на одну и ту же авиакомпанию (см. "Считаем, что ..." выше). Заполняется на основании рабочих и оперативных данных.
