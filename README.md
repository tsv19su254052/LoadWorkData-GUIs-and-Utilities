...
чтобы дать на вход скрипту привязки, или хотя бы дать URL до нее `file://P:/...`).
...
Найти способ добавить удобства и не вставлять исходник XML-ного файла в строке ввода в диалоге хранимой процедуры внутри Management Studio через буфер обмена,
а выбирать его в диалоге открытия файла или хотя бы дать URL до него `file:///P:/...`.
