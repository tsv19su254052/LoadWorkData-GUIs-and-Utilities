...
Для облегчения отладки выносим вставку новой строки или обновление XML-ных полей в существующей строке в хранимую процедуру вместе с частью на XPath & XQuery. Все XML-ные поля даем на вход хранимой процедуре через одну XSD-схему (каждое XML-ное поле через свой элемент XSD-схемы в соответствии с его именем за один раз).
