...
Поднять на сервере СУБД ВЭБ-хуки или Service Broker, чтобы отказаться от временных задержек на обходах взаимоблокировок и загрузить на максимально возможную нагрузку.
