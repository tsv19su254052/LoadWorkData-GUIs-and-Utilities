...
Добавить на графической формочке свойств объектов виждеты выбора:
 - страны,
 - области (графства, штата, региона),
 - города,
 - района города

из надежной онлайн базы по API-шкам. Добавить выджеты и ссылки для просмотра свойств вышеперечисленных географических объектов.
