...
Аттрибуты-идентификаторы в разных XML-ных полях могут указывать на одну и ту же авиакомпанию (см. "Считаем, что ..." выше). Заполняется на основании XML-ного поля регистрации при внесении рабочих и оперативных данных.

В соответствии с этим ищем строку летательного аппарата с данной регистрацией в данный период времени и в XML-ном поле относительно корневого тэга:
 - вставляются новый тэг и новый подтэг или в существующий тэг вставляется новый подтэг,
