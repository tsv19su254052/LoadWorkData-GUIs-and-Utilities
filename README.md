...
Регистрация с течением времени как правило последовательно меняет 4 ... 5 летательных аппаратов. Летательный аппарат однозначно определяется только сочетанием его заводских номеров (LN, MSN, SN, CN и другие) в зависимости от фирмы-изготовителя летательного аппарата, которое не указано в рабочих и оперативных данных.
В базах данных летательных аппаратов:
