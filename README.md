...
Исходный текст XSD-схемы вставляется в SQL-ный скрипт ее привязки к базе данных (надо найти способ добавить удобства и не вставлять исходник схемы через буфер обмена, а выбрать ее в диалоге открытия файла, чтобы дать на вход скрипту привязки).
...
#### Поправки по терминологии:
 ...
 - То, что SQL-ном скрипте называется **созданием схемы**, правильнее называть привязкой XSD-схемы, потому что она уже собрана и сохранена файлом типа `*.xsd`.
...
Найти способ добавить удобства и не вставлять исходник XML-ного файла в строке ввода в диалоге хранимой процедуры внутри Management Studio через буфер обмена, а выбирать его в диалоге открытия файла.
