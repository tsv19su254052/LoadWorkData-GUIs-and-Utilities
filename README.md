...
Уточнить использование комплектного с **MS SQL** функционала **XPath & XQuery** и комплектной спецификации **SQL/XML**, чтобы парсить поля **XML(CONTENT dbo.XSD-схема)** как **DOM** в базе данных летательных аппаратов и писать в нее XML-ное поле регистрации летательного аппарата и по одному XML-ному полю на авиакомпанию-лизингодателя, авиакомпанию-арендодателя, авиакомпанию-арендатора (владельца) и авиакомпанию-оператора при их наличии для каждого авиарейса следующим образом:
 ...
 - Аттрибуты из разных XML-ных полях авиакомпаний могут указывать на одну и ту же авиакомпанию, например когда авиарейс выполняет авиакомпания-владелец (нет лизинга, нет аренды, нет оператора) или когда авиарейс выполняет авиакомпания-оператор, использующая летательный аппарат авиакомпании-владельца (нет лизинга и нет аренды) или когда авиарейс выполняет авикомпания-оператор на летательном аппарате авиакомпании-арендатора (но без лизинга).
 - В каждой ветке может быть одна или несколько подветок с датами, соответствующими периодам использования (началами временного диапазона) в каждой авиакомпании.
