...
Структура хранилища с базами данных - **Снежинка** (в центре - таблицы с фактами, по краям - таблицы-справочники, которые ссылаются на другие таблицы-справочники). Тестовые таблицы с фактами вынесены в отдельные тестовые базы н другом жестком диске и ссылаются на те же таблицы-справочники, что и рабочие.
