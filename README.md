...
Регистрационный номер летательного аппарата (англ. _Tail Number_, далее по тексту **регистрация**) с течением времени как правило последовательно меняет 4 ... 5 летательных аппаратов.
...
XML-ное поле хронологии регистрационного номера летательного аппарата:
