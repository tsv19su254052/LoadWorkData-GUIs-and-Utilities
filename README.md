...
В объем данного проекта входит:
 ...
 - составление запросов к базам данных для анализа,
...
Оперативные данные загружаются асинхронно на API-шках по ВЭБ-хукам с http://www.flightradar24.com и с первичного оборудования.
