...
В соответствии с этим:
 - ищем строки летательных аппаратов и парсим в них XML-ные поля регистрации (XML-ный индекс) по тэгу с аттрибутом-строкой с указанной регистрацией,
...
В процессе загрузки рабочих и оперативных данных формируется список регистраций, которые надо восполнить в базе данных.
Недозагруженные данные на время пишутся во временную таблицу, как в 7-й версии.
