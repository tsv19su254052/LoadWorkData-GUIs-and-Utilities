...
_Таким образом, считаем, что:
 - в одном поле ветка авиакомпании должна быть одна, подветок с датами может быть несколько по количеству периодов использования в данной авиакомпании,
 - начало периода использования в следующей авиакомпании совпадает с окончанием периода использования в предыдущей, так как в рабочих данных не указаны периоды бездействия, чтобы избежать сдвоенных записей в подветках.
