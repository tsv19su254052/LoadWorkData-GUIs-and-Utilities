...
Добавить на графической формочке свойств объектов поиск объекта по названию в базе данных с выпадающим списком с автодополнением (требуется интеграция с поиском Google-а), добавить виджеты на вкладке ВПП (широта, долгота, абс. отметка, длина, ширина, покрытие полос, оснащение системой сближения и посадки и т. д.), ссылку по объекту на статью в Wikipedia.
...
Дополнить данные по маршрутам их профилями и их топологиями с привязкой к картам https://www.google.com/maps , а также их изменениями с течением времени.
