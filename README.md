...
Для облегчения отладки вставку новой строки или обновление существующей строки вынесена в хранимую процедуру с помеченными транзакциями вместе с частью на XPath & XQuery.
В метках транзакций указаны ...
