...
Пользователи работают в локальной подсети или из внешней сети на термнальном сервере через RDP.
...
Таблицы с тестовыми рабочими данными вынесены на другой жесткий диск и ссылаются на те же таблицы со справочными данными, что и рабочие.
