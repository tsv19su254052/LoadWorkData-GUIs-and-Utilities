...
Доработать базу данных по летательным аппаратам таким образом, чтобы:
 - писать в нее арендодателей, лизингодателей, арендаторов (владельцев) и всех операторов по XML-ному полю на каждую авиакомпанию для каждого авиарейса в разных комбинациях, как внешний ключ, ссылающийся на соответствующую запись в базе данных авиакомпаний,
 - писать при необходимости новую ветку и подветку или дописывать в существующую ветку новую подветку по указанному аттрибуту (авиакомпании) с указанием даты,
