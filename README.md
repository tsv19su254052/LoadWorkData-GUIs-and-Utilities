...
Группировка подтэгов с датами авиарейсов (пока в разработке):
 ...
 - определяемся в каких случаях необходимо программно или вручную выполнять группировку - каждый раз программно, потому что потом уже не определить: промежуточный подтэг или переход.
