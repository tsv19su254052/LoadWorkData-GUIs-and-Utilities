...
Доработать базу данных по летательным аппаратам таким образом, чтобы:
 - писать в нее арендодателей, лизингодателей, арендаторов (владельцев) и всех операторов в XML-ных полях на каждом авиарейсе, как внешний ключ, ссылающийся на таблицу авиакомпаний,
