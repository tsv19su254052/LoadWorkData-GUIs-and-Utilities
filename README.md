...
История изменений и улучшений в базах данных:
 ...
 - версия 7 - у летательных аппаратов по принципу _медленно меняющейся размерности_
   ...
   сделана хронология авиакомпаний (бизнес-ключ - сочетание заводских номеров, суррогатные ключи -  авиакомпании по периодам использования соответственно)
...
В соответствии с этим в XML-ном поле относительно корневого тэга:
