...
XML-ное поле хронологии регистрационных номеров летательных аппаратов (далее по тексту **регистрации**):
...
Примечания:
 ...
 - в 3 ... 5 версиях баз данных летательных аппаратов хронологии регистраций и авиакомпаний нет,
 - в 6-й версии базы данных летательных аппаратов хронологии регистраций и авиакомпаний нет, записан крайний регистрационный номер и крайняя авиакомпания,
 - в 7-й версии базы данных летательных аппаратов хронология регистраций и авиакомпаний сделана по принципу медленно меняющейся размерности,
 - в 8-й версии базы данных летательных аппаратов хронология регистраций и авиакомпаний сделана на XML-ных полях,
 - за 30 лет регистрация как правило последовательно меняет 4 ... 5 летательных аппарата,
 - однозначно летательный аппарат определяет только сочетание его заводских номеров (LN, MSN, SN, CN и другие в зависимости от фирмы-изготовителя летательного аппарата).
