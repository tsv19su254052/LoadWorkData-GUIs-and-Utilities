...
В процессе загрузки рабочих и оперативных данных составляем список регистраций, которые надо восполнить, чтобы дозагрузить незагруженные данные, которые пишутся во временную таблицу 7-й версии.
